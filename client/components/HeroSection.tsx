export function HeroSection() {
  return (
    <div className="relative h-56 md:h-64 rounded-2xl md:rounded-3xl overflow-hidden">
      <img
      ...
      <div className="relative h-full flex flex-col justify-center px-6 md:px-8">
        <h1 className="text-white text-2xl md:text-4xl font-medium max-w-xs leading-tight mb-4 md:mb-6">
          THE MOVEMENT<br />
          WITH A SOLID<br />
          FOUNDATION
        </h1>
        <button className="w-fit px-5 py-2 md:px-6 md:py-2.5 bg-brand-green rounded-lg text-white text-sm md:text-base font-medium hover:bg-brand-green/90 transition-colors">
          Explore now
        </button>
      </div>

      <div className="absolute bottom-4 md:bottom-8 right-4 md:right-8 hidden sm:block">
        <svg className="w-20 h-10 md:w-32 md:h-16" viewBox="0 0 126 68" fill="none" xmlns="http://www.w3.org/2000/svg">
